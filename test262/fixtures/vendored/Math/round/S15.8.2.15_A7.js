...
---*/
assert.sameValue(1 / Math.round(-0.5), 1 / -0, "The result of evaluating (1 / Math.round(-0.5)) is expected to be 1 / -0");

assert.sameValue(1 / Math.round(-0.25), 1 / -0, "The result of evaluating (1 / Math.round(-0.25)) is expected to be 1 / -0");
