...
assert.sameValue(Math.log10(10.0), 1, "Math.log10 produces incorrect output for 10.00");
assert.sameValue(Math.log10(100.0), 2, "Math.log10 produces incorrect output for 100.00");
assert.sameValue(Math.log10(1000.0), 3, "Math.log10 produces incorrect output for 1000.00");
