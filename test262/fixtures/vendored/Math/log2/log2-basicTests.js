...
assert.sameValue(Math.log2(2.0), 1, "Math.log2 produces incorrect output for 2.00");
assert.sameValue(Math.log2(4.0), 2, "Math.log2 produces incorrect output for 4.00");
assert.sameValue(Math.log2(8.0), 3, "Math.log2 produces incorrect output for 8.00");
