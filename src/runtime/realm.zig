...
const nativeReflectSetProto = meta_mod.nativeReflectSetProto;
const nativeReflectDefineProperty = meta_mod.nativeReflectDefineProperty;
const nativeReflectGetOwnPropertyDescriptor = meta_mod.nativeReflectGetOwnPropertyDescriptor;
const nativeReflectIsExtensible = meta_mod.nativeReflectIsExtensible;
const nativeReflectPreventExtensions = meta_mod.nativeReflectPreventExtensions;
...
pub fn installBuiltins(vm: *Vm) Error!void {
    ...
    try vm.defineMethod(reflect, "setPrototypeOf", nativeReflectSetProto, 2);
    try vm.defineMethod(reflect, "defineProperty", nativeReflectDefineProperty, 3);
    try vm.defineMethod(reflect, "getOwnPropertyDescriptor", nativeReflectGetOwnPropertyDescriptor, 2);
    try vm.defineMethod(reflect, "isExtensible", nativeReflectIsExtensible, 1);
    try vm.defineMethod(reflect, "preventExtensions", nativeReflectPreventExtensions, 1);
